...
from saliencyserieslab.explainers.leftist.learning_process.neighbors_generator.LIME_neighbors_generator import LIMENeighborsGenerator
...
class LIMELearningProcess(LearningProcess):
    ...
    def solve(self,neighbors,idx_label, explanation_size=None):
        ...
        return np.array([c[1] for c in coeff])
